...
export class UserService {
  ...
  private readonly usersUrl: string = 'https://44.202.115.183/mattmdb-1.0-SNAPSHOT/api/v2/users';
  private readonly mediaUrl: string = 'https://44.202.115.183/mattmdb-1.0-SNAPSHOT/api/v2/media';
