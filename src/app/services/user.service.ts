...
export class UserService {
  ...
  private readonly usersUrl: string = 'https://localhost/mattmdb-1.0-SNAPSHOT/api/v2/users';
  private readonly mediaUrl: string = 'https://localhost/mattmdb-1.0-SNAPSHOT/api/v2/media';
