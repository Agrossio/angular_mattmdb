...
export class UserService {
  ...
  private readonly usersUrl: string = 'https://44.201.170.61:443/mattmdb-1.0-SNAPSHOT/api/v2/users';
  private readonly mediaUrl: string = 'https://44.201.170.61:443/mattmdb-1.0-SNAPSHOT/api/v2/media';
