...
export class MediaService {
  ...
  searchMedia(searchString: string, page: number = 1): Observable<ITmdbResponse> {          // Retorna un observable de ITmdbResponse.
    ...
    return this.httpClient.get<ITmdbResponse>(`https://api.themoviedb.org/3/search/multi?api_key=e65c4db5bae2b9b0565c97b1e317145e&query=${searchString}&page=${page}&include_adult=false`);
